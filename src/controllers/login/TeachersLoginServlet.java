...
public class TeachersLoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //フォワード
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/login/teacherslogin.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(code != null && !code.equals("") && plain_pass != null && !plain_pass.equals("")) {
            ...
            try {
                t = em.createNamedQuery("checkLoginCodeAndPassword", Teacher.class)
        ...
        if(!check_result) {
            ...
            //セッションスコープにtを保存
            request.getSession().setAttribute("login_teacher", t);
            //フラッシュメッセージ
